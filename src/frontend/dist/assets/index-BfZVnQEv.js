...
const questions = [
  {
    ...
    answer: 2,
    explanation: "Smoking kills over 480,000 Americans per year — 1 in 5 deaths."
  },
  {
  ...
  },
  {
    ...
    answer: 3,
    explanation: "Nicotine reaches the brain in just 10 seconds — faster than most medicines."
  },
  {
    q: "Smokers are how many times more likely to get lung cancer?",
    options: ["2x", "5x", "10x", "15–30x"],
    answer: 3,
    explanation: "Smokers are 15 to 30 times more likely to develop lung cancer."
  },
  {
  ...
  },
  {
    ...
    answer: 1,
    explanation: "Within 20 minutes of quitting, heart rate and blood pressure begin to drop."
  },
  {
  ...
  },
  {
    ...
    answer: 2,
    explanation: "Nicotine triggers dopamine release — the feel-good chemical — trapping the brain."
  },
  {
    q: "After how many years smoke-free does lung cancer risk drop by half?",
    options: ["2 years", "5 years", "10 years", "20 years"],
    answer: 2,
    explanation: "After 10 smoke-free years, your lung cancer risk is cut in half."
  }
];
...
function TriviaGameSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "game", className: "py-20 sm:py-28 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-teal-100 text-teal-700 border-teal-200 font-body", children: "🧠 Trivia Quiz" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-4xl sm:text-5xl text-foreground mb-4", children: "SmokeFree Trivia" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-lg text-muted-foreground", children: "Test your knowledge about tobacco dangers!" })
    ] }),
    screen === "intro" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-br from-teal-50 to-emerald-50 border-2 border-teal-200 rounded-3xl p-8 sm:p-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-6xl mb-5", children: "🎯" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-2xl text-foreground mb-3", children: "How to Play" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-muted-foreground mb-2 max-w-sm mx-auto", children: [
        "Answer ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "10 questions" }),
        " about tobacco and smoking."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-muted-foreground mb-8 max-w-sm mx-auto", children: [
        "Each correct answer earns ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "10 points" }),
        ". Can you score 100/100?"
      ] }),
    ...
    (screen === "question" || screen === "reveal") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-body text-sm text-muted-foreground", children: [
          "Question ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: currentQ + 1 }),
          " of ",
          questions.length
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Progress, { value: progress, className: "h-3 mb-6 rounded-full" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-br from-teal-600 to-emerald-700 rounded-3xl p-6 sm:p-8 mb-6 shadow-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-2xl sm:text-3xl text-white leading-snug text-balance", children: question.q }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6", children: question.options.map((opt, idx) => {
        let cls = "border-2 border-border bg-white text-foreground hover:border-primary hover:bg-primary/5";
        if (screen === "reveal" && selected !== null) {
          if (idx === question.answer) {
            cls = "border-2 border-emerald-500 bg-emerald-50 text-emerald-800";
          } else if (idx === selected) {
            cls = "border-2 border-red-400 bg-red-50 text-red-700";
          } else {
            cls = "border-2 border-border bg-gray-50 text-muted-foreground opacity-50";
          }
        }
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: `w-full text-left p-4 rounded-2xl font-body font-medium transition-all duration-200 ${screen === "question" ? "cursor-pointer" : "cursor-default"} ${cls}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center justify-center w-7 h-7 rounded-full bg-primary/10 text-primary font-display font-bold text-sm mr-3 shrink-0", children: OPTION_LABELS[idx] }),
              opt
            ]
          },
          opt
      ...
      screen === "reveal" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-amber-50 border-2 border-amber-200 rounded-2xl p-4 mb-6 animate-fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-sm text-amber-800 leading-relaxed", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "💡 Did you know?" }),
        " ",
        question.explanation
      ] }) }),
      screen === "reveal" && showNext && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center animate-fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          size: "lg",
          ...
          children: currentQ + 1 < questions.length ? "Next Question →" : "See My Score 🏆"
        }
      ) })
    ] }),
    screen === "final" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center animate-fade-up", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-br from-teal-50 via-emerald-50 to-green-50 border-2 border-teal-200 rounded-3xl p-8 sm:p-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-5xl mb-4", children: "🏆" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-3xl text-foreground mb-4", children: "Quiz Complete!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-display font-black text-7xl sm:text-8xl text-primary mb-2", children: [
        score,
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl text-muted-foreground", children: "/100" })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground text-lg mb-8", children: grade.message }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3 justify-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#dangers", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            size: "lg",
            variant: "outline",
...
function VolunteerDonateSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "support", className: "py-20 sm:py-28 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ref,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-teal-100 text-teal-700 border-teal-200 font-body", children: "🤝 Get Involved" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-4xl sm:text-5xl text-foreground mb-5", children: "Help Someone Quit" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed", children: "You don't have to be a doctor to save a life. Here's how you can make a real difference." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `rounded-2xl border-2 border-green-200 bg-green-50 p-8 ${inView ? "animate-fade-up delay-100" : "opacity-0"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-3", children: "🙋" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-2xl text-green-800 mb-3", children: "Volunteer Your Time" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-green-900/75 leading-relaxed text-sm mb-6", children: "Share your voice, spread awareness, and support people trying to quit — in your community, school, or online." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: volunteerLinks.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: item.href,
                target: "_blank",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-500 text-base", children: "→" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `rounded-2xl border-2 border-teal-200 bg-teal-50 p-8 ${inView ? "animate-fade-up delay-200" : "opacity-0"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-3", children: "💛" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-2xl text-teal-800 mb-3", children: "Donate to a Cause" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-teal-900/75 leading-relaxed text-sm mb-6", children: "Even a small donation helps fund free quitlines, counseling, and support programs for people who want to quit." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: donateLinks.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: item.href,
                target: "_blank",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-teal-500 text-base", children: "→" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "group-hover:underline underline-offset-2", children: item.label })
                ]
              },
              item.ocid
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `rounded-2xl border-l-4 border-accent bg-accent/8 p-7 flex gap-4 items-start ${inView ? "animate-fade-up delay-300" : "opacity-0"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl shrink-0", children: "💬" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-foreground/80 leading-relaxed text-base", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "font-display font-bold text-foreground", children: "Every action counts." }),
            " ",
            "Whether you give an hour or a dollar, you're helping someone breathe easier."
          ] })
        ]
      }
    )
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: `font-display font-bold text-lg leading-tight transition-colors ${scrolled ? "text-primary" : "text-white"}`,
                children: "SmokeFree Future"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: `text-xs font-body font-medium tracking-wide transition-colors ${scrolled ? "text-muted-foreground" : "text-white/80"}`,
                children: "Breathe Better, Live Longer"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center gap-1", children: [
            navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                className: `px-4 py-2 rounded-full text-sm font-body font-medium transition-all ${scrolled ? "text-foreground hover:bg-primary/10 hover:text-primary" : "text-white/90 hover:text-white hover:bg-white/15"}`,
                children: link.label
              },
              link.href
            )),
        ...
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden bg-white/98 backdrop-blur-md border-b border-border px-4 pb-4 shadow-lg", children: [
          navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: link.href,
...
function HeroSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-screen flex items-center justify-center overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto pt-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-6 bg-white/20 text-white border-white/30 backdrop-blur-sm font-body text-sm px-4 py-1.5 animate-fade-in", children: "🌿 A Student Activist Movement" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-black text-5xl sm:text-6xl md:text-7xl text-white leading-tight mb-6 animate-fade-up delay-100 text-balance", children: [
        "The Future is",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic text-green-300", children: "Smoke-Free" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xl sm:text-2xl text-white/90 mb-4 animate-fade-up delay-200 font-light tracking-wide", children: "Breathe Better, Live Longer" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base sm:text-lg text-white/75 mb-10 max-w-2xl mx-auto animate-fade-up delay-300 leading-relaxed", children: "Every cigarette shortens a life. Together, we can build a generation that knows the truth about tobacco — and chooses health." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 justify-center animate-fade-up delay-400 flex-wrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#dangers", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            size: "lg",
            ...
            children: "📚 Learn the Facts"
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#game", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            size: "lg",
            ...
            children: "🧠 Take the Trivia"
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#support", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            size: "lg",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#help", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            size: "lg",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 animate-bounce opacity-60", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "svg",
        {
...
function DangersSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "dangers", className: "py-20 sm:py-28 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ref,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-red-100 text-red-700 border-red-200 font-body", children: "⚠️ The Dangers" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-4xl sm:text-5xl text-foreground mb-5", children: "What Smoking Does to Your Body" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed", children: "These aren't just warnings on a label — they're real facts backed by decades of scientific research from the CDC and leading health organizations." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: dangerStats.map((stat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `group rounded-2xl p-6 border-2 ${stat.bg} ${stat.border} card-hover ${inView ? `animate-fade-up delay-${Math.min((i + 1) * 100, 600)}` : "opacity-0"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-4", children: stat.emoji }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-start justify-between gap-2 mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h3",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-foreground/80 leading-relaxed mb-3", children: stat.desc }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-block text-xs font-body font-medium text-muted-foreground bg-white/60 px-2 py-1 rounded-full", children: [
            "Source: ",
            stat.source
          ] })
        ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `mt-12 rounded-3xl bg-primary text-primary-foreground p-8 sm:p-10 flex flex-col sm:flex-row items-center gap-6 ${inView ? "animate-fade-up delay-600" : "opacity-0"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-6xl shrink-0", children: "🚭" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-2xl mb-2", children: "There is NO safe level of tobacco use." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-primary-foreground/85 leading-relaxed", children: 'Even "light" smoking or occasional use causes real damage to your lungs, heart, and other organs. The only safe choice is to never start — or to quit as soon as possible.' })
          ] })
        ]
      }
    )
...
function AddictionSection() {
  const { ref, inView } = useInView();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "addiction", className: "py-20 sm:py-28 section-gradient", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ref,
        className: `text-center mb-16 ${inView ? "animate-fade-up" : "opacity-0"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-amber-100 text-amber-700 border-amber-200 font-body", children: "🧠 How Addiction Works" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-4xl sm:text-5xl text-foreground mb-5", children: "Why Tobacco is So Hard to Quit" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed", children: "Nicotine is one of the most addictive substances known to science. Here's what actually happens inside your brain when you smoke." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: addictionFacts.map((fact, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `bg-white rounded-2xl p-6 shadow-card border border-border card-hover ${inView ? `animate-fade-up delay-${Math.min((i + 1) * 100, 600)}` : "opacity-0"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-black text-3xl text-primary/20", children: fact.step }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: fact.emoji })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl text-foreground mb-3", children: fact.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground leading-relaxed", children: fact.desc })
        ]
      },
      fact.step
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: `mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 ${inView ? "animate-fade-up delay-600" : "opacity-0"}`,
        children: [
          {
            icon: "📊",
            stat: "9 out of 10",
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-black text-3xl text-primary mb-2", children: item.stat }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground", children: item.label })
            ]
          },
          item.stat
        ))
...
function QuitSection() {
  const { ref, inView } = useInView();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "quit", className: "py-20 sm:py-28 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ref,
        className: `text-center mb-16 ${inView ? "animate-fade-up" : "opacity-0"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-green-100 text-green-700 border-green-200 font-body", children: "🌱 The Path to Recovery" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-4xl sm:text-5xl text-foreground mb-5", children: "What Happens When You Quit?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed", children: "Your body is amazing — it starts healing the moment you stop smoking. Here's what happens on the road to recovery." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-6 top-0 bottom-0 w-0.5 bg-gradient-to-b from-accent via-primary to-accent/30 rounded-full hidden sm:block" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: timelineItems.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `flex gap-5 items-start ${inView ? `animate-fade-up delay-${Math.min((i + 1) * 100, 600)}` : "opacity-0"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden sm:flex flex-col items-center shrink-0 w-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "timeline-dot mt-1" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-card rounded-2xl border border-border p-5 shadow-card card-hover", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: item.icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-bold text-accent text-lg", children: [
                  "After ",
                  item.time
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-foreground/80 leading-relaxed text-sm sm:text-base", children: item.benefit })
            ] })
          ]
        },
        item.time
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-accent/10 border-2 border-accent/30 rounded-3xl p-8 sm:p-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-2xl sm:text-3xl text-foreground mb-3", children: "Your body wants to heal. 🌱" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground mb-6 max-w-lg mx-auto leading-relaxed", children: "It's never too late to quit. Every hour without a cigarette is your body getting stronger. The best time to stop is right now." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#help", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "bg-accent text-accent-foreground hover:opacity-90 font-body font-semibold px-8 py-3 rounded-full text-base shadow-sm", children: "Find Help to Quit →" }) })
        ] })
      }
    )
  ] }) });
...
function HelpSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 relative z-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ref,
            className: `text-center mb-16 ${inView ? "animate-fade-up" : "opacity-0"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-white/20 text-white border-white/30 font-body", children: "💚 You Are Not Alone" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-4xl sm:text-5xl text-white mb-5", children: "Ready to Get Help?" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-lg text-white/80 max-w-2xl mx-auto leading-relaxed", children: "Whether you want to quit yourself, or help someone you care about — these free resources are here for you, right now." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-6", children: resources.map((res, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `rounded-2xl p-7 border transition-all ${res.highlight ? "bg-white/15 border-white/40 shadow-hero" : "bg-white/8 border-white/20"} ${inView ? `animate-fade-up delay-${Math.min((i + 1) * 100, 500)}` : "opacity-0"} hover:bg-white/20`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-4", children: res.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3 mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl text-white", children: res.title }),
                res.highlight && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-accent text-accent-foreground border-0 font-body text-xs shrink-0", children: "Free 24/7" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white/75 leading-relaxed text-sm mb-5", children: res.desc }),
              res.action && res.href && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  href: res.href,
                  target: res.href.startsWith("http") ? "_blank" : void 0,
                  rel: "noreferrer",
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "bg-white/20 text-white border border-white/40 hover:bg-white/30 font-body font-semibold rounded-full text-sm", children: res.action })
                }
              ),
              !res.action && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white/50 text-xs italic", children: "No referral needed — just reach out." })
            ]
          },
          res.title
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `mt-10 bg-white/10 border border-white/25 rounded-2xl p-6 flex gap-4 items-start ${inView ? "animate-fade-up delay-500" : "opacity-0"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: "💡" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-bold text-white mb-1", children: "Craving a cigarette?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-white/75 text-sm leading-relaxed", children: [
                  "Try the 4D strategy: ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-white", children: "Delay" }),
                  " ",
                  "for 10 minutes,",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-white", children: " Deep breathe" }),
                  ",",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-white", children: " Drink water" }),
                  ", and",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-white", children: " Do something else" }),
                  " to distract yourself. Most cravings only last a few minutes!"
                ] })
              ] })
            ]
          }
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-foreground text-primary-foreground py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-xl text-white mb-1", children: "SmokeFree Future" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-white/60 text-sm italic", children: "Breathe Better, Live Longer" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 flex-wrap justify-center", children: [
        { href: "#dangers", label: "Dangers" },
        { href: "#addiction", label: "Addiction" },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 pt-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white/50 text-sm", children: "Created by a 6th grader who cares about our future. 🌿" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-white/40 text-sm", children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " SmokeFree Future | smokefreefuture.com |",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DangersSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AddictionSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(QuitSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TriviaGameSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(VolunteerDonateSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(HelpSection, {})
    ] }),
